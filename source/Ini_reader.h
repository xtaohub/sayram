...
class Ini_reader{
 public:
  ...
  struct section_not_found {
    std::string section;
    section_not_found(const std::string& section_ = std::string())
      :section(section_) {}
  };
...
protected:
  template < class T > static void string_as_T(const std::string & s, T& t);
...
/* static */
template < class T > void Ini_reader::string_as_T (const std::string & s, T& t) {
...
template <> inline void Ini_reader::string_as_T < std::string > (const std::string & sin, std::string& sout) {
...
/* static */
template <> inline void Ini_reader::string_as_T < bool > (const std::string & s, bool& b) {
  using std::cout;
  using std::endl;
